...
public class TelaCPF extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jMyCpfField1.addFocusListener(new java.awt.event.FocusAdapter()
        {
            public void focusLost(java.awt.event.FocusEvent evt)
            {
                jMyCpfField1FocusLost(evt);
            }
        });
    ...
    private void jMyCpfField1FocusLost(java.awt.event.FocusEvent evt)//GEN-FIRST:event_jMyCpfField1FocusLost
    {//GEN-HEADEREND:event_jMyCpfField1FocusLost
        if (this.jMyCpfField1.isRight())
        {
            this.jLabel1.setText("CPF correto");
        }
        else
        {
            this.jLabel1.setText("CPF incorreto");
        }
    }//GEN-LAST:event_jMyCpfField1FocusLost
